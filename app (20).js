...
function resetApp() {
  ...
  if (compareResults) { compareResults.style.display = 'none'; compareResults.innerHTML = ''; }
  if (compareIntro)   compareIntro.style.display = 'flex';
  if (compareBtn)     { compareBtn.disabled = false; compareBtn.textContent = '⚖️ Generate Comparison'; }

  // Destroy map
  if (mapInstance) { mapInstance.remove(); mapInstance = null; }

  // Clear shared trip from URL
